...
const ALL_GRANTS = [
  ...
  { id:9, title:"2026 문화기술 R&D 지원", org:"문체부", cat:"R&D",
    ...
    guideUrl:"https://www.mcst.go.kr/site/s_notice/notice/noticeList.jsp",
  ...
  { id:10, title:"2026 경기도 콘텐츠 기업 성장 지원", org:"경기콘텐츠", cat:"기업성장",
    ...
    guideUrl:"https://www.gcon.or.kr/gcon/business/gconNotice/list.do?menuNo=200061",
  ...
  { id:11, title:"2026 서울 영상콘텐츠 제작 지원", org:"서울산업", cat:"영상제작",
    ...
    guideUrl:"https://www.sba.seoul.kr/kr/sbcu31l1",
  ...
  { id:12, title:"2026 부산 영상산업 제작 인센티브", org:"부산영상", cat:"영상제작",
    ...
    url:"https://www.bfc.or.kr/NcPageLink?link=ko/grt/GRT040100&_menuNo=66",
    guideUrl:"https://www.bfc.or.kr/NcPageLink?link=ko/grt/GRT040100&_menuNo=66",
  ...
  // ── KOFIC 추가 공고 ──
  { id:13, title:"2026 한국영화 시나리오 공모전", org:"KOFIC", cat:"시나리오",
    budget:"최대 3천만원", budgetDetail:"대상 3천만원 / 최우수상 1천5백만원 / 우수상 5백만원 (총 5편 선정, 수상작 개발지원 연계)",
    deadline:"2026-05-31", period:"2026-04-01 ~ 2026-05-31 18:00", status:"접수중",
    url:KOFIC_LIST, guideUrl:KOFIC_LIST,
    contact:"영화진흥위원회 창작개발팀 051-720-4813",
    eligibility:"국내 거주 누구나 (기성·신인 구분 없음, 타 공모전 미수상작 한정, 1인 1편 접수)",
    desc:"한국영화 시나리오 저변 확대와 신인 작가 발굴을 위한 공모전. 수상작은 KOFIC 기획개발 연계 지원으로 실제 제작까지 이어지는 경로 제공. 총 500편 내외 접수 예상.",
    reqs:["시나리오 완본(A4 90~130매)","작품 개요서(로그라인·시놉시스)","작가 이력서","저작권 확인서"],
    eval:[{name:"완성도",w:35,d:"극작 완성도, 대사·구성"},{name:"독창성",w:30,d:"소재·관점의 신선함"},{name:"영화성",w:20,d:"영상화 가능성, 장면의 시각성"},{name:"대중성",w:15,d:"관객 흡인력, 상업적 가능성"}],
    match:78 },

  { id:14, title:"2026 AI 기반 영화 제작지원(장편)", org:"KOFIC", cat:"AI/기술",
    budget:"최대 6억원", budgetDetail:"장편 부문 편당 최대 6억원 (AI 기술 적용 비용 별도 최대 1억원 추가 지원), 5편 내외",
    deadline:"2026-05-16", period:"2026-04-07 ~ 2026-05-16 18:00", status:"접수중",
    url:KOFIC_LIST, guideUrl:KOFIC_LIST,
    contact:"영화진흥위원회 기술혁신팀 051-720-4890",
    eligibility:"AI 기술을 영화 제작 공정에 적용하는 국내 영화 제작사 (AI 기술 파트너사 컨소시엄 형태 가능)",
    desc:"생성형 AI·딥러닝 등 AI 기술을 제작 공정에 혁신적으로 적용하는 장편 극영화를 지원합니다. 사전 시각화(프리비즈), 배경 생성, AI 음향 합성 등 창의적 활용 사례 우대.",
    reqs:["시나리오 완본","AI 기술 적용 계획서","기술 파트너사 협약서","제작기획서","예산서(AI 비용 항목 분리)"],
    eval:[{name:"AI 혁신성",w:30,d:"기술 적용 독창성·실현가능성"},{name:"작품성",w:25,d:"시나리오·연출 비전"},{name:"제작역량",w:25,d:"감독·제작사 실적"},{name:"사업화",w:20,d:"배급 계획, 시장성"}],
    match:82 },

  { id:15, title:"2026 AI 기반 영화 제작지원(단편)", org:"KOFIC", cat:"AI/기술",
    budget:"최대 1억원", budgetDetail:"단편 부문 편당 5천만원~1억원 차등 (AI 기술비 최대 3천만원 별도), 10편 내외",
    deadline:"2026-05-16", period:"2026-04-07 ~ 2026-05-16 18:00", status:"접수중",
    url:KOFIC_LIST, guideUrl:KOFIC_LIST,
    contact:"영화진흥위원회 기술혁신팀 051-720-4890",
    eligibility:"만 40세 이하 신진 감독 또는 AI 기술 보유 개인·팀 (상업 장편 연출 경력 3편 미만)",
    desc:"AI 기술 활용 단편 영화 제작 지원으로 신진 영화인의 기술 역량 강화를 도모합니다. AI 비용 항목을 예산서에 명시할 경우 별도 심사 없이 추가 지원.",
    reqs:["시나리오(20~40매)","AI 활용 계획서(1~3페이지)","감독 소개서","제작계획서","예산서"],
    eval:[{name:"AI 활용 창의성",w:35,d:"기술 적용 방식의 독창성"},{name:"작품성",w:30,d:"연출 비전, 시나리오"},{name:"실현가능성",w:20,d:"일정·예산 현실성"},{name:"잠재력",w:15,d:"감독 성장 가능성"}],
    match:75 },

  { id:16, title:"2026 독립·예술영화 개봉지원", org:"KOFIC", cat:"독립영화",
    budget:"최대 1억5천만원", budgetDetail:"P&A(홍보·마케팅·배급) 비용 최대 1억5천만원 (영화 완성 후 신청, 개봉 3개월 전까지 접수)",
    deadline:"2026-07-31", period:"2026-04-01 ~ 2026-07-31 (연중 접수)", status:"접수중",
    url:KOFIC_LIST, guideUrl:KOFIC_LIST,
    contact:"영화진흥위원회 배급지원팀 051-720-4826",
    eligibility:"국내 독립·예술영화 배급사 또는 제작사 (완성 영화, 국내 극장 개봉 확정 작품 한정)",
    desc:"완성된 독립·예술영화의 극장 개봉 비용(홍보·마케팅·배급)을 지원합니다. 아트하우스 체인 연계 마케팅 컨설팅 무상 제공.",
    reqs:["영화 완성본(DCP 또는 링크)","개봉 확약서(배급사)","P&A 계획서","예산서","관람등급 심의 결과"],
    eval:[{name:"작품성",w:30,d:"영화 완성도, 영화제 수상 실적"},{name:"배급 전략",w:30,d:"상영관 확보 계획, 마케팅 방향"},{name:"P&A 적정성",w:25,d:"예산 항목 타당성"},{name:"기대 성과",w:15,d:"관객 목표, 미디어 노출 계획"}],
    match:71 },

  { id:17, title:"2026 한국영화 기획개발 지원(초기기획)", org:"KOFIC", cat:"기획개발",
    budget:"최대 5천만원", budgetDetail:"초기기획 단계 최대 5천만원 (시나리오 개발비·자문비 포함), 15건 내외 선정",
    deadline:"2026-06-05", period:"2026-04-28 ~ 2026-06-05 18:00", status:"접수중",
    url:KOFIC_LIST, guideUrl:KOFIC_LIST,
    contact:"영화진흥위원회 창작개발팀 051-720-4813",
    eligibility:"국내 영화 제작사 (사업자등록 후 1년 이상) 또는 시나리오 작가·감독 개인(수상 경력 보유)",
    desc:"장편 상업 영화 초기 기획 단계를 지원합니다. 트리트먼트 수준의 기획 아이디어만으로 신청 가능하며, 선정 후 6개월간 시나리오 개발비를 분할 지급합니다.",
    reqs:["기획의도서","트리트먼트(5~20페이지)","작가·감독 이력서","기획 일정표"],
    eval:[{name:"소재 독창성",w:35,d:"새로운 관점, 차별화된 소재"},{name:"기획 완성도",w:30,d:"세계관, 캐릭터 설득력"},{name:"시장성",w:20,d:"타겟 관객, 상업 가능성"},{name:"작가역량",w:15,d:"이전 작품, 수상 이력"}],
    match:79 },

  { id:18, title:"2026 한국영화 제작사 라인업 개발지원", org:"KOFIC", cat:"기획개발",
    budget:"최대 2억원", budgetDetail:"제작사당 최대 2억원 (다수 프로젝트 동시 개발비 지원), 10개사 내외 선정",
    deadline:"2026-06-20", period:"2026-05-12 ~ 2026-06-20 18:00", status:"공고예정",
    url:KOFIC_LIST, guideUrl:KOFIC_LIST,
    contact:"영화진흥위원회 창작개발팀 051-720-4814",
    eligibility:"장편 영화 2편 이상 제작 실적 보유 국내 제작사 (극장 개봉 또는 OTT 공개 이력)",
    desc:"중견 제작사의 차기 프로젝트 라인업 구축을 지원합니다. 한 개 제작사가 2~5개 프로젝트 동시 개발 가능하며, 해외 공동개발 프로젝트 포함 시 우대.",
    reqs:["개발 대상 프로젝트 목록(각 1~3장 개요)","제작사 실적 증빙","중장기 개발 전략","예산 운용 계획"],
    eval:[{name:"개발 전략",w:30,d:"라인업 구성의 다양성·전략성"},{name:"제작사 역량",w:30,d:"기존 제작·흥행 실적"},{name:"프로젝트 가능성",w:25,d:"선정 과제의 완성도"},{name:"해외 연계",w:15,d:"공동개발·공동제작 계획"}],
    match:66 },

  // ── KOCCA 추가 공고 ──
  { id:19, title:"2026 실감콘텐츠(XR·메타버스) 제작 지원", org:"KOCCA", cat:"실감/XR",
    budget:"최대 4억원", budgetDetail:"VR/AR/MR/메타버스 콘텐츠 과제당 최대 4억원 (정부 60%, 자부담 40%), 12개 과제",
    deadline:"2026-05-22", period:"2026-04-10 ~ 2026-05-22 18:00", status:"접수중",
    url:KOCCA_LIST, guideUrl:KOCCA_GUIDE,
    contact:"한국콘텐츠진흥원 실감콘텐츠팀 061-900-6451",
    eligibility:"국내 법인 중 VR·AR·XR 콘텐츠 제작 경력 보유 기업 (시제품 또는 프로토타입 보유 필수)",
    desc:"몰입형 실감콘텐츠(VR·AR·MR) 및 메타버스 콘텐츠 제작을 지원합니다. 총 사업규모 48억원. 전시·교육·엔터테인먼트·관광 분야 우대.",
    reqs:["기술기획서","프로토타입 시연 영상","사업계획서","예산서","기술인력 현황"],
    eval:[{name:"기술혁신성",w:30,d:"XR 기술 적용 독창성"},{name:"콘텐츠 품질",w:25,d:"몰입감, 완성도"},{name:"사업화 가능성",w:25,d:"수익모델, 유통 계획"},{name:"팀 역량",w:20,d:"기술·콘텐츠 전문인력 구성"}],
    match:77 },

  { id:20, title:"2026 한국 콘텐츠 해외 공동제작 지원", org:"KOCCA", cat:"해외공동",
    budget:"최대 5억원", budgetDetail:"공동제작 프로젝트당 최대 5억원 (해외 파트너사 공동 부담 30% 이상 필수), 8개 프로젝트",
    deadline:"2026-06-17", period:"2026-05-04 ~ 2026-06-17 17:00", status:"공고예정",
    url:KOCCA_LIST, guideUrl:KOCCA_GUIDE,
    contact:"한국콘텐츠진흥원 국제협력팀 061-900-6290",
    eligibility:"해외 제작사와 공식 공동제작 협약을 체결하거나 체결 예정인 국내 콘텐츠 기업 (MOU 또는 계약서 필수)",
    desc:"해외 제작사와 공동으로 개발·제작하는 한국 콘텐츠 프로젝트를 지원합니다. 일본·프랑스·캐나다 등 협정 체결국 파트너사 프로젝트 우선 심사.",
    reqs:["공동제작 기획서","해외 파트너사 협약서(MOU 또는 계약)","각 제작사 역할 분담 계획","예산서","국제 유통 계획"],
    eval:[{name:"국제 협력 가능성",w:30,d:"파트너십 구체성, 역할 분담"},{name:"작품성",w:25,d:"기획 완성도, 글로벌 소구력"},{name:"제작역량",w:25,d:"양국 제작사 실적"},{name:"사업성",w:20,d:"해외 배급·유통 전략"}],
    match:69 },

  { id:21, title:"2026 웹드라마·숏폼 콘텐츠 제작 지원", org:"KOCCA", cat:"방송영상",
    budget:"최대 2억원", budgetDetail:"웹드라마 최대 2억원 / 숏폼(60초~10분) 최대 5천만원 차등, 25편 내외 선정",
    deadline:"2026-05-08", period:"2026-03-31 ~ 2026-05-08 18:00", status:"마감임박",
    url:KOCCA_LIST, guideUrl:KOCCA_GUIDE,
    contact:"한국콘텐츠진흥원 방송영상산업팀 061-900-6238",
    eligibility:"국내 법인 또는 개인사업자 (OTT 플랫폼 유통 채널 보유 또는 협의 중인 경우 우대)",
    desc:"모바일·OTT 중심의 웹드라마 및 숏폼 콘텐츠 제작을 지원합니다. 유튜브·틱톡·릴스 등 소셜 플랫폼 연계 콘텐츠 포함. 총 사업규모 30억원.",
    reqs:["기획서(포맷·에피소드 구성)","파일럿 에피소드 또는 시연 영상","예산서","유통채널 현황(또는 협의 계획)"],
    eval:[{name:"기획력",w:30,d:"포맷 참신성, 에피소드 구성"},{name:"제작역량",w:25,d:"파일럿 완성도"},{name:"유통 전략",w:25,d:"플랫폼 연계 실현성"},{name:"대중성",w:20,d:"타겟 시청자, 조회 전망"}],
    match:85 },

  { id:22, title:"2026 인디 애니메이션 창작 지원", org:"KOCCA", cat:"애니메이션",
    budget:"최대 5천만원", budgetDetail:"작품당 2천만원~5천만원 차등 (1인 창작 포함, 국비 100%), 20편 내외",
    deadline:"2026-04-25", period:"2026-03-24 ~ 2026-04-25 17:00", status:"마감임박",
    url:KOCCA_LIST, guideUrl:KOCCA_GUIDE,
    contact:"한국콘텐츠진흥원 애니메이션산업팀 061-900-6393",
    eligibility:"개인 창작자 또는 5인 이하 소규모 팀 (국내 거주, 데뷔 여부 무관, 법인 불가)",
    desc:"1인 창작자·소규모 팀의 독립 애니메이션 제작을 지원합니다. 실험적·예술적 형식 우대. 완성작은 안시·부천·서울국제만화애니메이션페스티벌 출품 지원.",
    reqs:["작품 기획서","파일럿 클립(30초~3분)","감독 작업 포트폴리오","제작계획서","예산서"],
    eval:[{name:"예술성",w:40,d:"시각 언어 독창성, 작가 개성"},{name:"작품성",w:30,d:"스토리, 연출 완성도"},{name:"파일럿",w:20,d:"파일럿 완성도"},{name:"실현가능성",w:10,d:"일정·예산 현실성"}],
    match:73 },

  { id:23, title:"2026 지역 영상 콘텐츠 제작 지원", org:"문체부", cat:"영상제작",
    budget:"최대 3억원", budgetDetail:"권역별 2~5개 프로젝트 선정, 프로젝트당 최대 3억원 (수도권 외 지역 촬영 비중 50% 이상 필수)",
    deadline:"2026-06-30", period:"2026-05-19 ~ 2026-06-30 18:00", status:"공고예정",
    url:"https://www.mcst.go.kr/site/s_notice/notice/noticeList.jsp",
    guideUrl:"https://www.mcst.go.kr/site/s_notice/notice/noticeList.jsp",
    contact:"문화체육관광부 영상콘텐츠산업과 044-203-2537",
    eligibility:"수도권 외 지역 소재 영상 제작사 또는 수도권 소재라도 지방 촬영 비중 50% 이상 계획 제작사",
    desc:"지역 문화 자원을 활용한 영상 콘텐츠 제작을 지원하여 지역 영상산업 균형 발전을 도모합니다. 지역 스태프 고용 30% 이상 시 가점.",
    reqs:["기획서","제작계획서(지역 촬영 비중 명시)","예산서","지역 스태프 활용 계획","사업자등록증"],
    eval:[{name:"지역성",w:30,d:"지역 문화자원 활용도"},{name:"작품성",w:25,d:"기획 완성도"},{name:"지역고용",w:25,d:"현지 스태프·장비 활용 계획"},{name:"사업성",w:20,d:"유통·배급 계획"}],
    match:62 },

  { id:24, title:"2026 SBA 콘텐츠 스타트업 스케일업", org:"SBA", cat:"기업성장",
    budget:"최대 1억5천만원", budgetDetail:"제작비 최대 1억원 + 해외마케팅 최대 5천만원 (서울 소재 창업 3년 이내 기업 한정), 15개사",
    deadline:"2026-05-19", period:"2026-04-14 ~ 2026-05-19 18:00", status:"접수중",
    url:"https://www.sba.seoul.kr/kr/sbcu31l1",
    guideUrl:"https://www.sba.seoul.kr/kr/sbcu31l1",
    contact:"서울산업진흥원 스타트업성장팀 02-2085-8330",
    eligibility:"서울 소재 창업 3년 이내 콘텐츠 스타트업 (매출 30억 미만, 벤처기업 인증 또는 예비창업패키지 졸업 우대)",
    desc:"서울 소재 초기 콘텐츠 스타트업의 제작 역량 강화와 해외 시장 진입을 지원합니다. SBA 글로벌 센터(실리콘밸리·상하이·도쿄) 네트워킹 무상 연계.",
    reqs:["사업계획서","창업 증빙서류","재무제표","제품/서비스 데모(영상 또는 URL)","해외진출 계획서"],
    eval:[{name:"성장 잠재성",w:35,d:"시장 규모, 성장률 전망"},{name:"팀 역량",w:25,d:"창업팀 구성, 전문성"},{name:"제품 완성도",w:25,d:"데모 품질, 시장 검증"},{name:"해외 전략",w:15,d:"해외 진출 계획 구체성"}],
    match:80 },

  { id:25, title:"2026 경기 애니메이션·웹툰 기업 육성", org:"경기콘텐츠", cat:"기업성장",
    budget:"최대 8천만원", budgetDetail:"애니메이션 최대 8천만원 / 웹툰 최대 5천만원 (경기도 소재 필수, 직원 5인 이상), 30개사",
    deadline:"2026-04-28", period:"2026-04-07 ~ 2026-04-28 17:00", status:"마감임박",
    url:"https://www.gcon.or.kr/gcon/business/gconNotice/list.do?menuNo=200061",
    guideUrl:"https://www.gcon.or.kr/gcon/business/gconNotice/list.do?menuNo=200061",
    contact:"경기콘텐츠진흥원 기업지원팀 031-219-1042",
    eligibility:"경기도 소재 애니메이션·웹툰 제작 기업 (직원 5인 이상, 직전 3년 내 제작 실적 보유)",
    desc:"경기도 소재 애니메이션·웹툰 기업의 작품 제작 및 글로벌 진출을 지원합니다. 판교·부천 소재 기업 가점, BCWW(부천국제만화축제) 참가 지원 연계.",
    reqs:["사업계획서","제작 기획안","경기도 소재 증빙","실적 포트폴리오","재무제표(2년)"],
    eval:[{name:"제작역량",w:30,d:"이전 제작 실적, 품질"},{name:"기획력",w:25,d:"신규 프로젝트 완성도"},{name:"시장성",w:25,d:"국내외 유통 전략"},{name:"지역기여",w:20,d:"경기도 콘텐츠 생태계 기여"}],
    match:67 },

  { id:26, title:"2026 부산 독립영화 촬영 인프라 지원", org:"부산영상", cat:"독립영화",
    budget:"최대 3천만원", budgetDetail:"촬영장비·스튜디오 무상 대여 (현금 환산 최대 3천만원 상당), 20개 작품 선정",
    deadline:"2026-05-02", period:"2026-04-01 ~ 2026-05-02 18:00", status:"접수중",
    url:"https://www.bfc.or.kr/NcPageLink?link=ko/grt/GRT040100&_menuNo=66",
    guideUrl:"https://www.bfc.or.kr/NcPageLink?link=ko/grt/GRT040100&_menuNo=66",
    contact:"부산영상위원회 인프라지원팀 051-310-1075",
    eligibility:"부산 또는 경남 지역 독립영화 감독 (장·단편 무관, 상업 장편 연출 3편 미만)",
    desc:"부산영상위원회 보유 촬영장비와 스튜디오를 독립영화 제작팀에 무상 대여합니다. 4K 카메라·조명·음향장비 풀 세트, 실내 스튜디오 2개동 포함.",
    reqs:["촬영계획서","시나리오 또는 트리트먼트","감독 이력서","장비 활용 계획서"],
    eval:[{name:"작품성",w:35,d:"시나리오·기획 완성도"},{name:"지역연계",w:30,d:"부산·경남 촬영 비중"},{name:"실현가능성",w:20,d:"촬영 일정, 팀 구성"},{name:"감독 잠재력",w:15,d:"이전 작업, 수상 경력"}],
    match:64 },
];
